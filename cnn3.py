...
m = Initializer(train_path='val', val_path='')

class CNN(nn.Module):
	def __init__(self):
		super(CNN, self).__init__()
		self.init = nn.BatchNorm2d(1)
		self.conv1 = m.new_layer(1, 16, 5, 1, 2, drop_rate=0.2)
		self.conv2 = m.new_layer(16, 32, 5, 1, 2, drop_rate=0.2)
		self.conv3 = m.new_layer(32, 64, 3, 1, 0, drop_rate=0.2)
		self.out = m.new_fc2(64*5*5, 1024, 512, 7)
